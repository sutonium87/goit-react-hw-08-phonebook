...
// Define the functional component for the registration form
export function RegisterForm() {
  ...
  const handleSubmit = async event => {
    ...
    try {
      ...
      form.reset();
      // Show success notification upon successful registration
      Notify.success('Congratulations, you have successfully registered!');
    } catch (error) {
      // Show failure notification if user already exists
      Notify.failure('User already exists');
    }
  };

  // JSX structure for the registration form component
  return (
    <Container
      component="main"
      maxWidth="xs"
